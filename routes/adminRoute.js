const { getBatch, addBatch, updateBatch, deleteBatch, getStudent, addStudent, updateStudent, deleteStudent, getAttendance, addAttendance, updateAttendance, deleteAttendance, getStudentsByBatch } = require("../controller/adminController")
